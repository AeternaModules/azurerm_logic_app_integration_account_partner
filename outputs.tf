output "logic_app_integration_account_partners_id" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.id }
}
output "logic_app_integration_account_partners_business_identity" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.business_identity }
}
output "logic_app_integration_account_partners_integration_account_name" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.integration_account_name }
}
output "logic_app_integration_account_partners_metadata" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.metadata }
}
output "logic_app_integration_account_partners_name" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.name }
}
output "logic_app_integration_account_partners_resource_group_name" {
  ...
  value       = { for k, v in azurerm_logic_app_integration_account_partner.logic_app_integration_account_partners : k => v.resource_group_name }
}
